...
class TestBaseConversation(unittest.TestCase):
    def test_conversation_initialization(self):
        ...
        conversation = BaseConversation(
            conversation_id=str(uuid4()), messages=[initial_message]
        )
        ...
        self.assertEqual(
            conversation.messages[0].content[0]["content"], "Hello, DeepSeek!"
        )
    ...
    def test_to_json(self):
        ...
        conversation = BaseConversation(
            conversation_id=str(uuid4()), messages=[user_message]
        )
    ...
    def test_from_json(self):
        ...
        self.assertEqual(new_conversation.conversation_id,
                         conversation.conversation_id)
        self.assertEqual(len(new_conversation.messages), 1)
        self.assertEqual(
            new_conversation.messages[0].content[0]["content"],
